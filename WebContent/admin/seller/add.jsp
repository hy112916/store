			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="aid"  id="userAction_save_do_logonName"  class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						销售员名称：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="adminname"  id="userAction_save_do_logonName" class="bg"/>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="cid"  id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				<tr>
